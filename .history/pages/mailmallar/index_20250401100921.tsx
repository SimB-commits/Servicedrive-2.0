...
import MailPlanInfo from '@/components/email/MailPlanInfo';
  ...
  return (
    <section className="flex flex-col items-center justify-center gap-4 py-8 md:py-10">
      ...
      <div className="w-full max-w-6xl">
        {/* Visa information om prenumerationsplan */}
        <MailPlanInfo />
        ...
        >
          ...
          <Tab key="templates" title="Mailmallar">
            <div className="space-y-6 mt-4">
              {/* Komponent för mallinställningar */}
              ...
              <MailTemplateList 
                ...
                readOnly={!features.emailTemplates}
              />
            </div>
          </Tab>
