...
export default function Arendestatusar() {
  ...
  // Använd subscription hook för att hantera plangränser
  const subscription = useSubscription();
  const canUseCustomStatuses = subscription.canUseFeature('customStatuses');
  const canCreateMoreStatuses = subscription.canCreate('customStatus');
  ...
  return (
    <section className="flex flex-col items-center justify-center gap-4 py-8 md:py-10">
      <div className="inline-block max-w-lg text-center">
        ...
        {/* Visa knappen bara om användaren har möjlighet att skapa fler statusar */}
      ...
      {/* Visa PlanFeatureNotice om feature inte är tillgänglig i planen */}
      {!canUseCustomStatuses && (
        <PlanFeatureNotice
          feature="customStatuses"
          title="Anpassade statusar är inte tillgängliga"
          description={`Din ${subscription.planName} plan stödjer inte anpassade statusar. Uppgradera din plan för att skapa egna statusar.`}
            ...
            <Card className="mt-4">
              <CardHeader className="flex flex-col">
                <div className="flex justify-between items-center w-full">
                  ...
                  {/* Visa knappen om användaren har möjlighet att skapa fler statusar, annars visa PlanLimitNotice */}
                  {canUseCustomStatuses ? (
                    canCreateMoreStatuses ? (
                      <Button 
                        type="button" 
