      ...
      <Card>
        <CardHeader className="flex justify-between items-center">
          ...
          <div className="flex gap-2">
            ...
            {/* Visa knapp enbart om användaren har tillgång till funktionen */}
        ...
        <CardBody>
          ...
          {loading ? (
            ...
            searchQuery ? (
              ...
              <div className="text-center p-6 border rounded-md bg-default-50">
                <p className="text-default-600 mb-4">
                  Inga mailmallar skapade ännu. {canUseEmailTemplates ? 'Klicka på "Skapa ny mailmall" för att komma igång.' : 'Uppgradera din plan för att skapa mailmallar.'}
                </p>
                {canUseEmailTemplates ? (
                  <Button 
                    color="primary" 
                    ...
                    <TableCell>
                      <div className="flex items-center gap-2">
                        ...
                        <Button 
                          ...
                          isDisabled={!canUseEmailTemplates}
                        >
                          <EditIcon />
                        </Button>
                        
                        <Dropdown isDisabled={!canUseEmailTemplates}>
                          <DropdownTrigger>
                            <Button 
                              type="button" 
                              variant="flat" 
