...
export const Logo: React.FC<IconSvgProps> = ({ 
  ...
  <img 
    src="/images/Servicedrive-simplelogo.png"
    alt="ServiceDrive Logo" 
    style={{ 
      width: width || size || height || '100px', // Standardstorlek om inget anges
      height: height || size || width || 'auto', // Behåll proportioner
      objectFit: 'contain' // Säkerställer att bilden inte blir skev
    }}
    {...props}
  />
);
...
export const ChevronDown: React.FC<IconSvgProps> = ({ fill = "currentColor", size, height, width, ...props }) => (
...
export const EyeIcon: React.FC<IconSvgProps> = ({ size = 24, height, width, ...props }) => (
  <svg 
    aria-hidden="true" 
    fill="none" 
...
export const BellIcon: React.FC<IconSvgProps> = ({ size = 24, width, height, ...props }) => (
  <svg 
    height={size || height} 
    viewBox="0 0 24 24" 
    width={size || width} 
...
export const StoreIcon: React.FC<IconSvgProps> = ({ size = 24, width, height, ...props }) => (
  <svg 
    height={size || height} 
    viewBox="0 0 24 24" 
    width={size || width} 
...
export const ChevronDownIcon: React.FC<IconSvgProps> = ({ size = 24, width, height, ...props }) => (
  <svg 
    height={size || height} 
    viewBox="0 0 24 24" 
    width={size || width} 
...
export const QuestionCircleIcon = ({ size = 24, ...props }) => (
  <svg 
    height={size} 
    width={size} 
    viewBox="0 0 24 24" 
...
export const GuideIcon = ({ size = 20, ...props }) => (
  <svg 
    height={size} 
    width={size} 
    viewBox="0 0 24 24" 
...
export const ContactIcon = ({ size = 20, ...props }) => (
  <svg 
    height={size} 
    width={size} 
    viewBox="0 0 24 24" 
...
export const EmailIcon = ({ size = 18, ...props }) => (
  <svg 
    height={size} 
    width={size} 
    viewBox="0 0 24 24" 
...
// Ticket icon
export const TicketIcon = ({ size = 18, ...props }) => (
  <svg 
    height={size} 
    width={size} 
    viewBox="0 0 24 24" 
