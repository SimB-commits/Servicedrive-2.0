...
export default function TicketPage() {
  ...
  const getCustomerInfo = () => {
    ...
    return {
      name: ticket.customer.name || `${ticket.customer.firstName || ''} ${ticket.customer.lastName || ''}`.trim() || `Kund #${ticket.customer.id}`,
  ...
  // Hantera utskrift
  const handlePrint = () => {
    // The TicketPrinter component has internal handling for printing
    // We can directly trigger printing using its functionality
    if (ticket) {
      // Create a temporary instance of TicketPrinter and use its printing function
        ...
        <html>
          ...
          <body>
            <div class="print-container">
              ...
              <table>
                ${ticket.ticketType?.fields && ticket.ticketType.fields
